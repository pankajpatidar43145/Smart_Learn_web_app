...
import "./teacherregister.css"; // You can create the CSS file for the registration page styles
  ...
  const handleRegister = () => {
    ...
    axios
      ...
      .then((response) => {
        ...
        axios
          .post(
            "https://smart-learn-web-app-u8vp.onrender.com/teacherdata/create",
            {
              name,
              email,
              department,
    ...
    <div>
      ...
      <div style={backgroundStyle}>
        <div className="register-container">
          ...
          <p>
            Already have an account ? <Link to="/teacherlogin"> Login </Link>{" "}
          </p>{" "}
        </div>{" "}
      </div>{" "}
    </div>
