...
function AnalogClock() {
  ...
  bottom: 0;
  right: 0;
  margin: 12px; /* Adjust margin as needed for spacing */
  border-radius: 20%;
  color: black; /* Set text color to white */
    ...
    .seconds {
      --dRotate: 0deg;
      --dail-size: calc((var(--clock-size)/ 2) - 28px);
      font-weight: 500;
      font-size: 12px;
  ...
  return (
    <div>
      ...
      <div className="clock">
        <div className="seconds"> </div> <div className="minutes"> </div>{" "}
        <div className="minute"> 44 </div> <div className="hour"> </div>{" "}
      </div>{" "}
    </div>
  );
}
