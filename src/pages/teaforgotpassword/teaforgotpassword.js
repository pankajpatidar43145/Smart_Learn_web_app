...
import "./teaforgotpassword.css"; // You can create the CSS file for the forgot password page styles
...
const ForgotPassword = () => {
  ...
  const handleSendOTP = () => {
    ...
    axios
      .post(
        "https://smart-learn-web-app-u8vp.onrender.com/teacherdata/check-email-exists",
        {
          email,
        }
      )
  ...
  const handleResetPassword = () => {
    ...
    axios
      .post(
        `https://smart-learn-web-app-u8vp.onrender.com/teacherdata/change-password/${email}`,
        {
    ...
    <div>
      ...
      <div style={backgroundStyle}>
        <div className="forgot-password-container">
          ...
          <p>
            Remember your password ? <Link to="/teacherlogin"> Login </Link>{" "}
          </p>{" "}
        </div>{" "}
      </div>{" "}
    </div>
